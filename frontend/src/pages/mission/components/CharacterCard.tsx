...
export function CharacterCard({ senderName, channel, time, avatarUrl }: CharacterCardProps) {
  return (
    <div className="flex gap-3 items-center">
      <div className="w-14 h-14 sm:w-16 sm:h-16 shrink-0 rounded-md border border-[#ff0033]/80 bg-gradient-to-br from-[#1a0308] to-[#300810] flex items-center justify-center text-[#ff3355] shadow-[0_0_10px_rgba(255,0,51,0.35)] overflow-hidden">
        {avatarUrl ? (
      ...
      <div className="flex flex-col gap-0.5 font-digital text-[11px] sm:text-xs">
