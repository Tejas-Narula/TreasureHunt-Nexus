...
export function MissionPage() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#070204] flex justify-center px-3 py-5 sm:px-4 sm:py-6">
      <div className="w-full max-w-[460px] flex flex-col gap-3.5 sm:gap-4">
        ...
        <button
          ...
          className="mt-1 self-center font-digital text-[10px] tracking-wider text-zinc-600 hover:text-zinc-400 border border-zinc-800 hover:border-zinc-600 rounded px-3 py-1.5 transition-colors cursor-pointer"
        >
