...
export function FreezeOverlay({ isFrozen, taskLabel = 'COMPLETE THE TASK' }: FreezeOverlayProps) {
  ...
  return (
    <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-3 rounded-lg bg-[#070204]/92 backdrop-blur-sm border border-[#ff0033]/40 text-center px-6">
      <Lock className="w-8 h-8 sm:w-10 sm:h-10 text-[#ff0033] animate-pulse drop-shadow-[0_0_10px_rgba(255,0,51,0.7)]" />
      <div className="font-digital text-[#ff3355] font-bold text-xs sm:text-sm tracking-[0.15em]">
        SCREEN LOCKED
      </div>
      <div className="font-digital text-zinc-400 text-[10.5px] sm:text-xs max-w-[240px] leading-relaxed">
